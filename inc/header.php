<!-- Navbar -->
<?php
       require('user/essential.php');
       require('user/db_config.php');
    //    userlogin();
       session_start();
       if((isset($_SESSION['userLogin']) && $_SESSION['userLogin']==true)){
        redirect('/proj/user/user_panel.php');
       }
?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex">
            ...
            <button type="button" class="btn btn-outline-dark shadow-none me-lg-3 me-2">
                <a href="/proj/user/user_login.php" class="text-reset text-decoration-none">
                    Login
                </a>
            </button>
            <button type="button" class="btn btn-outline-dark shadow-none" >
                <a href="/proj/admin/ad_login.php" class="text-reset text-decoration-none">
                    Admin Login
                </a>
            </button>
        </div>
