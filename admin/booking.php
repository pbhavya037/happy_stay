...
<head>
  ...
  <title>Admin_Panel/Bookings</title>
         ...
         <div class="overflow-x-auto relative border-2 border-gray-400 sm:rounded-lg" id="example">
            <table class="w-full text-sm text-left text-gray-500 overflow-y-scroll ">
               ...
               <tbody>
                  ...
                  for($i = 1;$i<=$k;$i++){
                     $ii = $ress[$i-1]['book_id'];
                     $in = $ress[$i-1]['check_in'];
                     $out = $ress[$i-1]['check_out'];
                     $ad = $ress[$i-1]['address'];
                     $adr = $ress[$i-1]['aadhaar'];
                     $gt = $ress[$i-1]['guest'];
                     $ph = $ress[$i-1]['arrived'];
                     $amt = $ress[$i-1]['amount'];
                     $cus_id = $ress[$i-1]['cus_id'];
                     $nm = $ress[$i-1]['name'];
                  ...
                  <td class="py-4 px-6 text-left">
                     <form>
                        ...
                        <input type="submit" name="delete" value="Clear" class="font-medium text-green-700 hover:underline">
                     </form>
                  </td>
                  </tr>
                  qq;
