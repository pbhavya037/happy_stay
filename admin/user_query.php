...
<head>
   ...
   <title>Admin_Panel/User Oueries</title>
...
<body class="h-screen">
   ...
   <div class="flex h-full ">
            ...
            <ul class="space-y-2">
               <li>
                  <a href="dashboard.php" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 ">
                     <svg aria-hidden="true" class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 " fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
               ...
               <li>
                  <a href="users.php" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                     <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 640 512">
               ...
               <li>
                  <a href="staff.php" class="flex items-center items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                     <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 640 512">
      ...
      <!-- Content -->
      <div class=" basis-4/5 overflow-scroll p-10" id="example">

         <p class="text-xl font-bold mb-6">Queries</p>
         <div class="border-2 bg-gray-50 overflow-scroll shadow-lg rounded-xl p-4 border-black" id="example" style="height: 50%;" >
            <div class="flex justify-between mb-6">
               <p class="text-lg">Unresolved Queries</p>
            ...
            <div class="overflow-x-auto relative border-2 border-gray-400 sm:rounded-lg" id="example">
               <table class="w-full text-sm text-left text-gray-500 overflow-y-scroll " >
                  ...
                  <tbody>
                     ...
                     for ($i = 1; $i <= $k; $i++) {
                        $ii = $ress[$i - 1]['query_no'];
                        $nm = $ress[$i - 1]['q_datetime'];
                        $ds = $ress[$i - 1]['message'];
                        echo <<<qq
                  ...
                  <form action="user_query_model.php" method="POST">
                  <input type="hidden" name="gg" value=$ii>
                  <input type="submit" value="Resolve" class="font-medium text-blue-600 hover:underline" >
                  </form> 
                  </td>
                  </tr>
                  qq;
         ...
         <div class="border-2 mt-10 bg-gray-50 overflow-scroll shadow-lg rounded-xl p-4 border-black" id="example" style="height: 50%;">
            <div class="flex justify-between mb-6">
               <p class="text-lg">Resolved Queries</p>
               <i class="fa-solid fa-pen-to-square hover:cursor-pointer" onclick="document.getElementById('f_edit-modal').classList.remove('hidden')"></i>
            </div>
         ...
         <div id="resolve-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed flex items-center justify-center z-50 w-full bg-black bg-opacity-75 md:inset-0 h-modal md:h-full">
            <div class="relative p-4 w-full max-w-md h-full  md:h-auto">
               <!-- Modal content -->
               <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                  <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" onclick="document.getElementById('resolve-modal').classList.add('hidden')">
                  ...
                  <div class="py-6 px-6 lg:px-8">
                     ...
                     <form class="space-y-6" method="POST">
                        ...
                        <button type="submit" name="reslove_chng" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Save Changes</button>
